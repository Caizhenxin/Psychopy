...
expName = 'IAT(test05)'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\GitHub_programe\\GitHub\\Psychopy\\IAT\\IAT(test05)_lastrun.py',
...
def setupDevices(expInfo, thisExp, win):
    ...
    if deviceManager.getDevice('key_resp_iso') is None:
        # initialise key_resp_iso
        key_resp_iso = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='key_resp_iso',
        )
    ...
    if deviceManager.getDevice('key_resp_ipn') is None:
        # initialise key_resp_ipn
        key_resp_ipn = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='key_resp_ipn',
        )
    ...
    if deviceManager.getDevice('key_resp_iso_reverse') is None:
        # initialise key_resp_iso_reverse
        key_resp_iso_reverse = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='key_resp_iso_reverse',
        )
    ...
    if deviceManager.getDevice('key_resp_ipn_reverse') is None:
        # initialise key_resp_ipn_reverse
        key_resp_ipn_reverse = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='key_resp_ipn_reverse',
        )
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        ...
        languageStyle='LTR',
        depth=0.0);
    key_resp_iso = keyboard.Keyboard(deviceName='key_resp_iso')
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        ...
        languageStyle='LTR',
        depth=0.0);
    key_resp_ipn = keyboard.Keyboard(deviceName='key_resp_ipn')
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        ...
        languageStyle='LTR',
        depth=0.0);
    key_resp_iso_reverse = keyboard.Keyboard(deviceName='key_resp_iso_reverse')
    
    # --- Initialize components for Routine "Feedback_iso_reverse" ---
    fb_4 = visual.TextStim(win=win, name='fb_4',
        text='',
        font='Open Sans',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    # --- Initialize components for Routine "Practice_ipn_reverse" ---
    text_5 = visual.TextStim(win=win, name='text_5',
        ...
        languageStyle='LTR',
        depth=0.0);
    key_resp_ipn_reverse = keyboard.Keyboard(deviceName='key_resp_ipn_reverse')
    
    # --- Initialize components for Routine "Feedback_ipn_reverse" ---
    fb_5 = visual.TextStim(win=win, name='fb_5',
        text='',
        font='Open Sans',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    fb_6 = visual.TextStim(win=win, name='fb_6',
        text='',
        font='Open Sans',
        pos=(0, 0), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    for thisPractice_01 in Practice_01:
        ...
        # keep track of which components have finished
        Practice_isoComponents = [text, key_resp_iso]
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            # if key_resp_iso is starting this frame...
            if key_resp_iso.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                key_resp_iso.frameNStart = frameN  # exact frame index
                key_resp_iso.tStart = t  # local t and not account for scr refresh
                key_resp_iso.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(key_resp_iso, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'key_resp_iso.started')
                # update status
                key_resp_iso.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(key_resp_iso.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(key_resp_iso.clearEvents, eventType='keyboard')  # clear events on next screen flip
            
            # if key_resp_iso is stopping this frame...
            if key_resp_iso.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > key_resp_iso.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    key_resp_iso.tStop = t  # not accounting for scr refresh
                    key_resp_iso.tStopRefresh = tThisFlipGlobal  # on global time
                    key_resp_iso.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'key_resp_iso.stopped')
                    # update status
                    key_resp_iso.status = FINISHED
                    key_resp_iso.status = FINISHED
            if key_resp_iso.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_iso.getKeys(keyList=['e','i'], ignoreKeys=["escape"], waitRelease=False)
                _key_resp_iso_allKeys.extend(theseKeys)
                if len(_key_resp_iso_allKeys):
                    key_resp_iso.keys = _key_resp_iso_allKeys[-1].name  # just the last key pressed
                    key_resp_iso.rt = _key_resp_iso_allKeys[-1].rt
                    key_resp_iso.duration = _key_resp_iso_allKeys[-1].duration
                    # was this correct?
                    if (key_resp_iso.keys == str(ans)) or (key_resp_iso.keys == ans):
                        key_resp_iso.corr = 1
                    else:
                        key_resp_iso.corr = 0
                    # a response ends the routine
        ...
        # check responses
        if key_resp_iso.keys in ['', [], None]:  # No response was made
            key_resp_iso.keys = None
        ...
        Practice_01.addData('key_resp_iso.keys',key_resp_iso.keys)
        Practice_01.addData('key_resp_iso.corr', key_resp_iso.corr)
        if key_resp_iso.keys != None:  # we had a response
            Practice_01.addData('key_resp_iso.rt', key_resp_iso.rt)
            Practice_01.addData('key_resp_iso.duration', key_resp_iso.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    for thisPractice_02 in Practice_02:
        ...
        # keep track of which components have finished
        Practic_ipnComponents = [text_2, key_resp_ipn]
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            # if key_resp_ipn is starting this frame...
            if key_resp_ipn.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                key_resp_ipn.frameNStart = frameN  # exact frame index
                key_resp_ipn.tStart = t  # local t and not account for scr refresh
                key_resp_ipn.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(key_resp_ipn, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'key_resp_ipn.started')
                # update status
                key_resp_ipn.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(key_resp_ipn.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(key_resp_ipn.clearEvents, eventType='keyboard')  # clear events on next screen flip
            
            # if key_resp_ipn is stopping this frame...
            if key_resp_ipn.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > key_resp_ipn.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    key_resp_ipn.tStop = t  # not accounting for scr refresh
                    key_resp_ipn.tStopRefresh = tThisFlipGlobal  # on global time
                    key_resp_ipn.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'key_resp_ipn.stopped')
                    # update status
                    key_resp_ipn.status = FINISHED
                    key_resp_ipn.status = FINISHED
            if key_resp_ipn.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_ipn.getKeys(keyList=['e','i'], ignoreKeys=["escape"], waitRelease=False)
                _key_resp_ipn_allKeys.extend(theseKeys)
                if len(_key_resp_ipn_allKeys):
                    key_resp_ipn.keys = _key_resp_ipn_allKeys[-1].name  # just the last key pressed
                    key_resp_ipn.rt = _key_resp_ipn_allKeys[-1].rt
                    key_resp_ipn.duration = _key_resp_ipn_allKeys[-1].duration
                    # was this correct?
                    if (key_resp_ipn.keys == str(ans_ipn)) or (key_resp_ipn.keys == ans_ipn):
                        key_resp_ipn.corr = 1
                    else:
                        key_resp_ipn.corr = 0
                    # a response ends the routine
        ...
        # check responses
        if key_resp_ipn.keys in ['', [], None]:  # No response was made
            key_resp_ipn.keys = None
            # was no response the correct answer?!
        ...
        Practice_02.addData('key_resp_ipn.keys',key_resp_ipn.keys)
        Practice_02.addData('key_resp_ipn.corr', key_resp_ipn.corr)
        if key_resp_ipn.keys != None:  # we had a response
            Practice_02.addData('key_resp_ipn.rt', key_resp_ipn.rt)
            Practice_02.addData('key_resp_ipn.duration', key_resp_ipn.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    # set up handler to look after randomisation of conditions etc
    Formal_T1 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_t1.xlsx'),
        seed=None, name='Formal_T1')
    thisExp.addLoop(Formal_T1)  # add the loop to the experiment
    thisFormal_T1 = Formal_T1.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisFormal_T1.rgb)
    if thisFormal_T1 != None:
        for paramName in thisFormal_T1:
            globals()[paramName] = thisFormal_T1[paramName]
    
    for thisFormal_T1 in Formal_T1:
        currentLoop = Formal_T1
        thisExp.timestampOnFlip(win, 'thisRow.t', format=globalClock.format)
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        if key_resp_t1.keys in ['', [], None]:  # No response was made
            ...
            if str(ans_t1).lower() == 'none':
               ...
               key_resp_t1.corr = 0;  # failed to respond (incorrectly)
        # store data for Formal_T1 (TrialHandler)
        Formal_T1.addData('key_resp_t1.keys',key_resp_t1.keys)
        Formal_T1.addData('key_resp_t1.corr', key_resp_t1.corr)
        if key_resp_t1.keys != None:  # we had a response
            Formal_T1.addData('key_resp_t1.rt', key_resp_t1.rt)
            Formal_T1.addData('key_resp_t1.duration', key_resp_t1.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 1.0 repeats of 'Formal_T1'
    ...
    # set up handler to look after randomisation of conditions etc
    Practice_iso_Reverse = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_iso _reverse.xlsx'),
        seed=None, name='Practice_iso_Reverse')
    thisExp.addLoop(Practice_iso_Reverse)  # add the loop to the experiment
    thisPractice_iso_Reverse = Practice_iso_Reverse.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisPractice_iso_Reverse.rgb)
    if thisPractice_iso_Reverse != None:
        for paramName in thisPractice_iso_Reverse:
            globals()[paramName] = thisPractice_iso_Reverse[paramName]
    
    for thisPractice_iso_Reverse in Practice_iso_Reverse:
        currentLoop = Practice_iso_Reverse
        thisExp.timestampOnFlip(win, 'thisRow.t', format=globalClock.format)
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Practice_iso_reverse.started', globalClock.getTime(format='float'))
        text_4.setText(Words)
        key_resp_iso_reverse.keys = []
        key_resp_iso_reverse.rt = []
        _key_resp_iso_reverse_allKeys = []
        # keep track of which components have finished
        Practice_iso_reverseComponents = [text_4, key_resp_iso_reverse]
        for thisComponent in Practice_iso_reverseComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "Practice_iso_reverse" ---
        routineForceEnded = not continueRoutine
        while continueRoutine and routineTimer.getTime() < 1.5:
            # get current time
            t = routineTimer.getTime()
            ...
            # if key_resp_iso_reverse is starting this frame...
            if key_resp_iso_reverse.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                key_resp_iso_reverse.frameNStart = frameN  # exact frame index
                key_resp_iso_reverse.tStart = t  # local t and not account for scr refresh
                key_resp_iso_reverse.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(key_resp_iso_reverse, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'key_resp_iso_reverse.started')
                # update status
                key_resp_iso_reverse.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(key_resp_iso_reverse.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(key_resp_iso_reverse.clearEvents, eventType='keyboard')  # clear events on next screen flip
            
            # if key_resp_iso_reverse is stopping this frame...
            if key_resp_iso_reverse.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > key_resp_iso_reverse.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    key_resp_iso_reverse.tStop = t  # not accounting for scr refresh
                    key_resp_iso_reverse.tStopRefresh = tThisFlipGlobal  # on global time
                    key_resp_iso_reverse.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'key_resp_iso_reverse.stopped')
                    # update status
                    key_resp_iso_reverse.status = FINISHED
                    key_resp_iso_reverse.status = FINISHED
            if key_resp_iso_reverse.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_iso_reverse.getKeys(keyList=['e','i'], ignoreKeys=["escape"], waitRelease=False)
                _key_resp_iso_reverse_allKeys.extend(theseKeys)
                if len(_key_resp_iso_reverse_allKeys):
                    key_resp_iso_reverse.keys = _key_resp_iso_reverse_allKeys[-1].name  # just the last key pressed
                    key_resp_iso_reverse.rt = _key_resp_iso_reverse_allKeys[-1].rt
                    key_resp_iso_reverse.duration = _key_resp_iso_reverse_allKeys[-1].duration
                    # was this correct?
                    if (key_resp_iso_reverse.keys == str(ans)) or (key_resp_iso_reverse.keys == ans):
        ...
        for thisComponent in Practice_iso_reverseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Practice_iso_reverse.stopped', globalClock.getTime(format='float'))
        # check responses
        if key_resp_iso_reverse.keys in ['', [], None]:  # No response was made
            key_resp_iso_reverse.keys = None
            # was no response the correct answer?!
            if str(ans).lower() == 'none':
               key_resp_iso_reverse.corr = 1;  # correct non-response
            else:
               key_resp_iso_reverse.corr = 0;  # failed to respond (incorrectly)
        # store data for Practice_iso_Reverse (TrialHandler)
        Practice_iso_Reverse.addData('key_resp_iso_reverse.keys',key_resp_iso_reverse.keys)
        Practice_iso_Reverse.addData('key_resp_iso_reverse.corr', key_resp_iso_reverse.corr)
        if key_resp_iso_reverse.keys != None:  # we had a response
            Practice_iso_Reverse.addData('key_resp_iso_reverse.rt', key_resp_iso_reverse.rt)
            Practice_iso_Reverse.addData('key_resp_iso_reverse.duration', key_resp_iso_reverse.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Feedback_iso_reverse.started', globalClock.getTime(format='float'))
        ...
        fb_4.setColor(fb_col, colorSpace='rgb')
        fb_4.setText(fb_text)
        # keep track of which components have finished
        Feedback_iso_reverseComponents = [fb_4]
        for thisComponent in Feedback_iso_reverseComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "Feedback_iso_reverse" ---
        routineForceEnded = not continueRoutine
        while continueRoutine and routineTimer.getTime() < 1.0:
            # get current time
            t = routineTimer.getTime()
            ...
            # if fb_4 is starting this frame...
            if fb_4.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                fb_4.frameNStart = frameN  # exact frame index
                fb_4.tStart = t  # local t and not account for scr refresh
                fb_4.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(fb_4, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'fb_4.started')
                # update status
                fb_4.status = STARTED
                fb_4.setAutoDraw(True)
            
            # if fb_4 is active this frame...
            if fb_4.status == STARTED:
                # update params
                pass
            
            # if fb_4 is stopping this frame...
            if fb_4.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > fb_4.tStartRefresh + 1.0-frameTolerance:
                    # keep track of stop time/frame for later
                    fb_4.tStop = t  # not accounting for scr refresh
                    fb_4.tStopRefresh = tThisFlipGlobal  # on global time
                    fb_4.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'fb_4.stopped')
                    # update status
                    fb_4.status = FINISHED
        ...
        for thisComponent in Feedback_iso_reverseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Feedback_iso_reverse.stopped', globalClock.getTime(format='float'))
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 1.0 repeats of 'Practice_iso_Reverse'
    ...
    # set up handler to look after randomisation of conditions etc
    Practice_ipn_Reverse = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_ipn _reverse.xlsx'),
        seed=None, name='Practice_ipn_Reverse')
    thisExp.addLoop(Practice_ipn_Reverse)  # add the loop to the experiment
    thisPractice_ipn_Reverse = Practice_ipn_Reverse.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisPractice_ipn_Reverse.rgb)
    if thisPractice_ipn_Reverse != None:
        for paramName in thisPractice_ipn_Reverse:
            globals()[paramName] = thisPractice_ipn_Reverse[paramName]
    
    for thisPractice_ipn_Reverse in Practice_ipn_Reverse:
        currentLoop = Practice_ipn_Reverse
        thisExp.timestampOnFlip(win, 'thisRow.t', format=globalClock.format)
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        # --- Prepare to start Routine "Practice_ipn_reverse" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Practice_ipn_reverse.started', globalClock.getTime(format='float'))
        text_5.setText(Words_ipn)
        key_resp_ipn_reverse.keys = []
        key_resp_ipn_reverse.rt = []
        _key_resp_ipn_reverse_allKeys = []
        # keep track of which components have finished
        Practice_ipn_reverseComponents = [text_5, key_resp_ipn_reverse]
        for thisComponent in Practice_ipn_reverseComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "Practice_ipn_reverse" ---
        routineForceEnded = not continueRoutine
        while continueRoutine and routineTimer.getTime() < 1.5:
            # get current time
            t = routineTimer.getTime()
            ...
            # *key_resp_ipn_reverse* updates
            waitOnFlip = False
            
            # if key_resp_ipn_reverse is starting this frame...
            if key_resp_ipn_reverse.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                key_resp_ipn_reverse.frameNStart = frameN  # exact frame index
                key_resp_ipn_reverse.tStart = t  # local t and not account for scr refresh
                key_resp_ipn_reverse.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(key_resp_ipn_reverse, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'key_resp_ipn_reverse.started')
                # update status
                key_resp_ipn_reverse.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(key_resp_ipn_reverse.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(key_resp_ipn_reverse.clearEvents, eventType='keyboard')  # clear events on next screen flip
            
            # if key_resp_ipn_reverse is stopping this frame...
            if key_resp_ipn_reverse.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > key_resp_ipn_reverse.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    key_resp_ipn_reverse.tStop = t  # not accounting for scr refresh
                    key_resp_ipn_reverse.tStopRefresh = tThisFlipGlobal  # on global time
                    key_resp_ipn_reverse.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'key_resp_ipn_reverse.stopped')
                    # update status
                    key_resp_ipn_reverse.status = FINISHED
                    key_resp_ipn_reverse.status = FINISHED
            if key_resp_ipn_reverse.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_ipn_reverse.getKeys(keyList=['e','i'], ignoreKeys=["escape"], waitRelease=False)
                _key_resp_ipn_reverse_allKeys.extend(theseKeys)
                if len(_key_resp_ipn_reverse_allKeys):
                    key_resp_ipn_reverse.keys = _key_resp_ipn_reverse_allKeys[-1].name  # just the last key pressed
                    key_resp_ipn_reverse.rt = _key_resp_ipn_reverse_allKeys[-1].rt
                    key_resp_ipn_reverse.duration = _key_resp_ipn_reverse_allKeys[-1].duration
                    # was this correct?
                    if (key_resp_ipn_reverse.keys == str(ans_ipn)) or (key_resp_ipn_reverse.keys == ans_ipn):
                        key_resp_ipn_reverse.corr = 1
                    else:
                        key_resp_ipn_reverse.corr = 0
                    # a response ends the routine
                    continueRoutine = False
        ...
        # --- Ending Routine "Practice_ipn_reverse" ---
        for thisComponent in Practice_ipn_reverseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Practice_ipn_reverse.stopped', globalClock.getTime(format='float'))
        # check responses
        if key_resp_ipn_reverse.keys in ['', [], None]:  # No response was made
            key_resp_ipn_reverse.keys = None
            # was no response the correct answer?!
            if str(ans_ipn).lower() == 'none':
               key_resp_ipn_reverse.corr = 1;  # correct non-response
            else:
               key_resp_ipn_reverse.corr = 0;  # failed to respond (incorrectly)
        # store data for Practice_ipn_Reverse (TrialHandler)
        Practice_ipn_Reverse.addData('key_resp_ipn_reverse.keys',key_resp_ipn_reverse.keys)
        Practice_ipn_Reverse.addData('key_resp_ipn_reverse.corr', key_resp_ipn_reverse.corr)
        if key_resp_ipn_reverse.keys != None:  # we had a response
            Practice_ipn_Reverse.addData('key_resp_ipn_reverse.rt', key_resp_ipn_reverse.rt)
            Practice_ipn_Reverse.addData('key_resp_ipn_reverse.duration', key_resp_ipn_reverse.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        # --- Prepare to start Routine "Feedback_ipn_reverse" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Feedback_ipn_reverse.started', globalClock.getTime(format='float'))
        # Run 'Begin Routine' code from fb_code_5
        # Check if the key press was correct or not.
        # This routine will need to follow another routine with a 
        # key response component in it called "key_resp" 
        # and the "store correct" option enabled. 
        ...
        fb_5.setColor(fb_col, colorSpace='rgb')
        fb_5.setText(fb_text)
        # keep track of which components have finished
        Feedback_ipn_reverseComponents = [fb_5]
        for thisComponent in Feedback_ipn_reverseComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "Feedback_ipn_reverse" ---
        routineForceEnded = not continueRoutine
        while continueRoutine and routineTimer.getTime() < 1.0:
            # get current time
            t = routineTimer.getTime()
            ...
            # if fb_5 is starting this frame...
            if fb_5.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                fb_5.frameNStart = frameN  # exact frame index
                fb_5.tStart = t  # local t and not account for scr refresh
                fb_5.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(fb_5, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'fb_5.started')
                # update status
                fb_5.status = STARTED
                fb_5.setAutoDraw(True)
            
            # if fb_5 is active this frame...
            if fb_5.status == STARTED:
                # update params
                pass
            
            # if fb_5 is stopping this frame...
            if fb_5.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > fb_5.tStartRefresh + 1.0-frameTolerance:
                    # keep track of stop time/frame for later
                    fb_5.tStop = t  # not accounting for scr refresh
                    fb_5.tStopRefresh = tThisFlipGlobal  # on global time
                    fb_5.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'fb_5.stopped')
                    # update status
                    fb_5.status = FINISHED
                    fb_5.setAutoDraw(False)
        ...
        # --- Ending Routine "Feedback_ipn_reverse" ---
        for thisComponent in Feedback_ipn_reverseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Feedback_ipn_reverse.stopped', globalClock.getTime(format='float'))
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 1.0 repeats of 'Practice_ipn_Reverse'
    ...
    # set up handler to look after randomisation of conditions etc
    Formal_t2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_t2.xlsx'),
        seed=None, name='Formal_t2')
    thisExp.addLoop(Formal_t2)  # add the loop to the experiment
    thisFormal_t2 = Formal_t2.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisFormal_t2.rgb)
    if thisFormal_t2 != None:
        for paramName in thisFormal_t2:
            globals()[paramName] = thisFormal_t2[paramName]
    
    for thisFormal_t2 in Formal_t2:
        currentLoop = Formal_t2
        thisExp.timestampOnFlip(win, 'thisRow.t', format=globalClock.format)
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Practice_t2.started', globalClock.getTime(format='float'))
        text_6.setText(Words_t2)
        key_resp_t2.keys = []
        key_resp_t2.rt = []
        _key_resp_t2_allKeys = []
        # keep track of which components have finished
        Practice_t2Components = [text_6, key_resp_t2]
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            if key_resp_t2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
            ...
            if key_resp_t2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > key_resp_t2.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if key_resp_t2.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_t2.getKeys(keyList=['e','i'], ignoreKeys=["escape"], waitRelease=False)
                ...
                if len(_key_resp_t2_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_t2.keys == str(ans_t2)) or (key_resp_t2.keys == ans_t2):
                        key_resp_t2.corr = 1
                    else:
                        key_resp_t2.corr = 0
                    # a response ends the routine
        ...
        for thisComponent in Practice_t2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Practice_t2.stopped', globalClock.getTime(format='float'))
        # check responses
        if key_resp_t2.keys in ['', [], None]:  # No response was made
            key_resp_t2.keys = None
            # was no response the correct answer?!
            if str(ans_t2).lower() == 'none':
               key_resp_t2.corr = 1;  # correct non-response
            else:
               key_resp_t2.corr = 0;  # failed to respond (incorrectly)
        # store data for Formal_t2 (TrialHandler)
        Formal_t2.addData('key_resp_t2.keys',key_resp_t2.keys)
        Formal_t2.addData('key_resp_t2.corr', key_resp_t2.corr)
        if key_resp_t2.keys != None:  # we had a response
            Formal_t2.addData('key_resp_t2.rt', key_resp_t2.rt)
            Formal_t2.addData('key_resp_t2.duration', key_resp_t2.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Feedback_t2.started', globalClock.getTime(format='float'))
        ...
        fb_6.setColor(fb_col, colorSpace='rgb')
        fb_6.setText(fb_text)
        # keep track of which components have finished
        Feedback_t2Components = [fb_6]
        for thisComponent in Feedback_t2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine and routineTimer.getTime() < 1.0:
            ...
            # if fb_6 is starting this frame...
            if fb_6.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                fb_6.frameNStart = frameN  # exact frame index
                fb_6.tStart = t  # local t and not account for scr refresh
                fb_6.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(fb_6, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'fb_6.started')
                # update status
                fb_6.status = STARTED
                fb_6.setAutoDraw(True)
            
            # if fb_6 is active this frame...
            if fb_6.status == STARTED:
                # update params
                pass
            
            # if fb_6 is stopping this frame...
            if fb_6.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > fb_6.tStartRefresh + 1.0-frameTolerance:
                    # keep track of stop time/frame for later
                    fb_6.tStop = t  # not accounting for scr refresh
                    fb_6.tStopRefresh = tThisFlipGlobal  # on global time
                    fb_6.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'fb_6.stopped')
                    # update status
                    fb_6.status = FINISHED
        ...
        for thisComponent in Feedback_t2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Feedback_t2.stopped', globalClock.getTime(format='float'))
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 1.0 repeats of 'Formal_t2'
