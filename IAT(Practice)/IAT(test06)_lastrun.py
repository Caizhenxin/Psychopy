...
expName = 'IAT(test06)'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\GitHub_programe\\GitHub\\Psychopy\\IAT\\IAT(test06)_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # set up handler to look after randomisation of conditions etc
    Practice_t2_Reverse = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
    ...
    for thisPractice_t2_Reverse in Practice_t2_Reverse:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 1.0 repeats of 'Practice_t2_Reverse'
    ...
    # set up handler to look after randomisation of conditions etc
    Formal_t2_reverse = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_t2.xlsx'),
    ...
    for thisFormal_t2_reverse in Formal_t2_reverse:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 1.0 repeats of 'Formal_t2_reverse'
