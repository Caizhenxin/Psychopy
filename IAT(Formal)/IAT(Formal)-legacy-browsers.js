...
function Instruction01RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction01Components.forEach( function(thisComponent) {
...
function Instruction02RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction02Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practice_iso_ReverseLoopBegin(Practice_iso_ReverseLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    Practice_iso_Reverse.forEach(function() {
...
function Practice_t2_ReverseLoopBegin(Practice_t2_ReverseLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    Practice_t2_Reverse.forEach(function() {
...
function Formal_t2_reverseLoopBegin(Formal_t2_reverseLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    Formal_t2_reverse.forEach(function() {
...
function Practice_isoRoutineBegin(snapshot) {
  return async function () {
    ...
    Practice_isoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback_iso_PracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    Feedback_iso_PracticeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction03RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction03Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practic_ipnRoutineBegin(snapshot) {
  return async function () {
    ...
    Practic_ipnComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback_ipn_PracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    Feedback_ipn_PracticeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction04RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction04Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practice_t1RoutineBegin(snapshot) {
  return async function () {
    ...
    Practice_t1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback_t1RoutineBegin(snapshot) {
  return async function () {
    ...
    Feedback_t1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction05RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction05Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction06RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction06Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practice_iso_reverseRoutineBegin(snapshot) {
  return async function () {
    ...
    Practice_iso_reverseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback_iso_reverseRoutineBegin(snapshot) {
  return async function () {
    ...
    Feedback_iso_reverseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction07RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction07Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practice_t2_reverseRoutineBegin(snapshot) {
  return async function () {
    ...
    Practice_t2_reverseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback_t2_reverseRoutineBegin(snapshot) {
  return async function () {
    ...
    Feedback_t2_reverseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction08RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction08Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practice_t2RoutineBegin(snapshot) {
  return async function () {
    ...
    Practice_t2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback_t2RoutineBegin(snapshot) {
  return async function () {
    ...
    Feedback_t2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
