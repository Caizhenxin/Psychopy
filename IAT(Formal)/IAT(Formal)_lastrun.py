...
expName = 'IAT(Formal)'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\GitHub_programe\\GitHub\\Psychopy\\IAT(Formal)\\IAT(Formal)_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # set up handler to look after randomisation of conditions etc
    Formal_T1 = data.TrialHandler(nReps=2.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_t1.xlsx'),
    ...
    for thisFormal_T1 in Formal_T1:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 2.0 repeats of 'Formal_T1'
    ...
    # set up handler to look after randomisation of conditions etc
    Formal_t2_reverse = data.TrialHandler(nReps=2.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Loop/Practice_t2.xlsx'),
    ...
    for thisFormal_t2_reverse in Formal_t2_reverse:
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed 2.0 repeats of 'Formal_t2_reverse'
